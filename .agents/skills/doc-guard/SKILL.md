...
Use `/doc-guard` before substantial documentation edits. Reconcile related
README/index entries, status labels, links, or changelog/backlog records when
those systems apply in the repository.
