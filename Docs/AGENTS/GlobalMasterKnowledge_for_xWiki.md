---
title: "Global MasterKnowledge for BestWorkplace xWiki Work – Core Rules & Document Handling"
version: 0.7
status: draft
owner: "Robert Schaub"
primary_systems:
...
- version: 0.7
  date: "2026-02-15"
  changes:
    - "Adapted from FactHarbor GlobalMasterKnowledge v0.7 for BestWorkplace project."
    - "Removed FactHarbor-specific organisational wording (GLOBAL-R-009)."
    - "Removed TASK-R-007 (not applicable to BestWorkplace)."
    - "Updated all project-specific references to BestWorkplace."
    - "Retained all generic xWiki rules, Troubleshooting Guide, Cursor IDE Workflow Rules, Markdown Conversion Commands, and Keyword Commands."
---

# Global MasterKnowledge for BestWorkplace xWiki Work – Core Rules & Document Handling
...
- Write rules that apply to the whole project, not just the specific document you are editing.

**GLOBAL-R-009 – Project-specific wording**
- Use consistent terminology throughout the project documentation.
- When referring to the project, use **"BestWorkplace"**.
...
**GLOBAL-P-001 – BestWorkplace chat initialization handshake (mandatory)**
...
- **Naming Convention:** Include date and version in XAR filename for traceability.
  ...
  - Example: `BestWorkplace_Content_15.Feb.26.xar`
  - Fixed version: `BestWorkplace_Content_15.Feb.26_Fixed.xar`
- **Delta vs Full:**
  - Delta XAR: Only changed pages, smaller file, quick import
  - Full XAR: All pages, complete snapshot, definitive version
...
- Every task should have an **origin prefix** identifying the project or chat that "owns" it, for example:
  - `BestWorkplace: prepare content snapshot rules`
...
- The user may explicitly override the origin prefix, e.g.:
  ```text
  t [BestWorkplace Content] Add new page about servant leadership
  t [BestWorkplace] Add new rule to GlobalMasterKnowledge
```
...
_End of Global MasterKnowledge v0.7 (BestWorkplace adaptation)_
